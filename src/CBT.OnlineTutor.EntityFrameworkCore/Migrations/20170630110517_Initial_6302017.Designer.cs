...
namespace CBT.OnlineTutor.Migrations
{
    ...
    [Migration("20170630110517_Initial_6302017")]
    partial class Initial_6302017
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CBT.OnlineTutor.EClass.CBTContentOptions", b =>
                {
                    b.HasOne("CBT.OnlineTutor.EClass.CBTContent", "CBTContents")
                        .WithMany("CBTContentOption")
                        .HasForeignKey("CBTContentsId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
